...
<div id="content">
    <form action="<?=base_url("admin/news/edit_news/{$data['id']}/{$parent_id}");?>" method="post" enctype="multipart/form-data">
        <table class="admin_module_form">
            ...
            <tr>
                <td class="admin_module_form_title">новинка</td>
                <td>
                    <input type="checkbox" name="novelty" <?=!empty($data['novelty']) && $data['novelty'] == '1' ? 'checked' : '';?> />
                </td>
            </tr>
            <tr>
                <td class="admin_module_form_title">акция</td>
                <td>
                    <input type="checkbox" name="action" <?=!empty($data['action']) && $data['action'] == '1' ? 'checked' : '';?> />
                </td>
            </tr>
            <tr>
