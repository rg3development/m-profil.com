  ...
  <div class="text_module">
    <form action="<?= $section->link('item_add'); ?>" method="post" enctype="multipart/form-data">
      ...
      <table class="admin_module_form photo_module_edit">
        ...
        <tr>
          <td class="admin_module_form_title">анонс</td>
          <td>
            <textarea id="anno" name="anno"><?= set_value('anno'); ?></textarea>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="admin_module_form_title"><strong>Характеристики</strong></td>
          <td></td>
        </tr>
